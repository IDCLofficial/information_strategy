...
const contactInfo = {
  address: "Block 10, Imo State Secretariat Complex, Owerri, Imo State, Nigeria",
  email: "ist@imostate.gov.ng",
  phone: "+234 706 839 4782",
  socials: [
    { icon: <FaFacebookF />, href: "https://www.facebook.com/profile.php?id=100085296764382" },
  ],
};

const ContactInfoSection = () => (
  <div className="mb-8 md:mb-0">
    <p className="mb-4 text-[#151A21] text-[1rem]">We welcome your inquiries, suggestions, and feedbacks on how we can improve the infromation sector of imo state</p>
